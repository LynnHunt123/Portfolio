...
it("Should set winners", function () {
    ...
    ***********/
    return result.register({ from: accounts[3] });/*<CODE HERE>*/
}).then(function (result) {
    /**********
    TASK 9: Call register function from account 4
    ***********/
    return result.register({ from: accounts[4] });/*<CODE HERE>*/
}).then(function () {
    /**********
    ...
    ***********/
    /*<CODE HERE>*/
    assert.notEqual(result.toString(), '0x0000000000000000000000000000000000000000', "Does not match default address.");
    /**********
